...
<%@ taglib prefix="login" uri="http://java.sun.com/jsp/jstl/core" %>
<html>
<head>
    <meta charset="UTF-8">
    <title>登陆账号</title>
...
<div style="background-color: white;margin: 0;">
    <ul>
        <li><img style="width: 50px; height: 25px" src="img/网易云.png"></li>
...
<img style="position: fixed;left:15%;top: 25%" src="img/login.png">
